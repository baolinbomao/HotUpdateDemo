...
cc._RF.push(module, 'e1b90/rohdEk4SdmmEZANaD', 'HotUpdate', __filename);
// Script/HotUpdate.ts
...
var HotUpdate = /** @class */ (function (_super) {
    ...
    //创建热更新管理器
    HotUpdate.prototype.createAM = function () {
        //如果不是Native，则不需要热更新
        if (!cc.sys.isNative) {
            return;
        }
    ...
    // 检查热更新
    HotUpdate.prototype.initManifest = function () {
        //官网写法
        ...
        if (jsb.fileUtils.isDirectoryExist(this._storagePath)) {
            ...
            var jsonStr = jsb.fileUtils.getStringFromFile(this.custom_Manifest_Path);
    ...
    HotUpdate.prototype.initJson = function (json) {
    ...
    //加载manifest
    HotUpdate.prototype.loadManifest = function (error, jsonString) {
        ...
        if (jsonString.length > 0) {
            ...
            var manifest = new jsb.Manifest(jsonString, this._storagePath);
            this._am.loadLocalManifest(manifest, this._storagePath);
            this.checkUpdate();
        }
    };
    ...
    //重新检查更新
    HotUpdate.prototype.retryCheck = function () {
        this._am.checkUpdate();
    };
    // 开始更新
    ...
    HotUpdate.prototype.updateCB = function (event) {
        ...
        if (needRestart) {
            ...
            var newPath = this._am.getLocalManifest().getSearchPaths();
    ...
    //重新下载失败的文件
    HotUpdate.prototype.retryUpdate = function () {
